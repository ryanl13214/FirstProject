...
export default class ChatV2 extends Component
{
    ...
    */
    ...
    getRightForPregenMsg()
    {




return this.state.rightmsgleft;
}
    ...
    render()
    {
        ...
        < View style={{width:width,height:"100%",backgroundColor:"rgb(115,198,216)"  }} >
          ...
          <TouchableOpacity style={{width:250    ,backgroundColor:"white" ,  borderColor: 'darkblue',borderRadius:12,borderWidth:2 ,  position:"absolute" ,right:this.getRightForPregenMsg(),bottom:"15%" }}   onPress={() =>  this.submitSET("What can i do with this app?")}>
...
{/*
          <TouchableOpacity style={{width:155   ,backgroundColor:"white"  ,  borderColor: 'darkblue',borderRadius:12, borderWidth:2 ,  position:"absolute" ,right:10,bottom:"14%" }}   onPress={() =>  this.submitSET("What causes PCOS?")}>
              <Text style={{  marginLeft:15,  fontSize: 18,color:"black"     }}>What causes PCOS?</Text>
          </TouchableOpacity>
*/}
{/* bascl nutton*/}
