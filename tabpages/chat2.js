      ...
      />
          ...
          <View style={{
            ...
            marginLeft: 5,marginRight: 5,
              minHeight: 35,backgroundColor:"white",
            height: heightTextbox  ,
            borderRadius:19,
            width:widthTextbox
          }}>
          <Text style={{  marginLeft:15,  fontSize: 20,color:"black"     }}>{conents}</Text>
          </View>
        <Image style={{width:userImage, height:50 , borderRadius:27   }} source={require('../imgs/placeholdericonhomepage.png')} />
...
export default class ChatV2 extends Component
{
    ...
    _keyboardWillShow()
    {
        //this.setState({ chatheight: height*0.1 });
    }
    _keyboardWillHide()
    {
        //   this.setState({ chatheight: height*0.56 });
    }
    _keyboardDidShow()
    {}
    _keyboardDidHide()
    ...
    /*
    _keyboardDidShow () {
        //  this.setState({ chatheight: height*0.4 });
    }
    ...
    */
    ...
    getreply(msg)
    {
        ...
        fetch('http://143.198.13.168:80/chat',
            {
                method: 'POST',
                headers:
                {
            ...
            .then((responseData) =>
            {
                ...
                data.push(
                {
                    id: 'systeminitmessagge' + responseData,
                    conents: responseData,
                    user: "user",
                    floats: "flex-start",
                    systemImage: 50,
                    userImage: 0,
    ...
    render()
    {
        ...
        < View style={{width:width,height:"100%",backgroundColor:"rgb(115,198,216)" }} >
            <Image style={{position:"absolute"  ,  width: '100%', height: height  ,resizeMode: 'stretch'  }} source={require('../imgs/NEWIMAGES/chatback.png')} />
            < View style={{width:width,height:this.getchatheight(),marginTop:"20%"  }} >
                <FlatList
                numColumns={1}
                horizontal={false}
                  data={data}
          ...
          <TouchableOpacity style={{width:250    ,backgroundColor:"white" ,  borderColor: 'darkblue',borderRadius:12,borderWidth:2 ,  position:"absolute" ,right:10,bottom:"20%" }}   onPress={() =>  this.submitSET("What can i do with this app?")}>
              <Text style={{  marginLeft:15,  fontSize: 18,color:"black"     }}>What can i do with this app?</Text>
          </TouchableOpacity>


          <TouchableOpacity style={{width:"100%"   ,  position:"absolute"  , justifyContent: "center", textAlign: 'center', alignItems: 'center', top:"2%" }}   onPress={() =>  this.submitSET("What can i do with this app?")}>
              <Text style={{  fontSize: 22,color:"white"     }}>Chat</Text>
          </TouchableOpacity>



          <TouchableOpacity style={{width:155   ,backgroundColor:"white"  ,  borderColor: 'darkblue',borderRadius:12, borderWidth:2 ,  position:"absolute" ,right:10,bottom:"14%" }}   onPress={() =>  this.submitSET("What is PCOS?")}>
              <Text style={{  marginLeft:15,  fontSize: 18,color:"black"     }}>What is PCOS?</Text>
          </TouchableOpacity>


          < View style={{width:width,height:"12%",minHeight:60,   position:"absolute",bottom:0,flexDirection:"row"}} >
              <TextInput style = {{width:width-95,height:"50%",minHeight:50 ,  borderColor: 'darkblue', borderWidth:2, fontSize: 18,backgroundColor:"rgb(230,230,230)",borderRadius:22 ,marginTop:4 ,marginLeft:5}}
              ...
              <Text style={{  marginLeft:15,  fontSize: 20,color:"black"     }}>SEND</Text>
              </TouchableOpacity>
           </ View>
			  </ View>
        );
