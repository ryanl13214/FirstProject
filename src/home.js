...
export default class Home extends React.Component
{
   ...
   <View style={{ alignItems: "center", justifyContent: "center", textAlign: 'center',  position:"absolute",top:"1%",left:"0%",width:"100%" }}>
   <Image style={{ marginLeft: "45%", height:height*0.14 ,resizeMode:"contain" }} source={require('../imgs/NEWIMAGES/logo2.png')} />
{/*      <Text  style={{ fontSize:23,color:"white" }}>PCOS Buddy</Text>*/}

   </View>


     <View style={{ marginLeft:"4%", marginTop:"10%",flexDirection:"row"  }} >
       <TouchableOpacity style={{width:55,height:55}}  onPress={this.selectPhotoid.bind(this)}>
          <Image style={{  width: '100%', height: '100%', borderRadius:27 ,resizeMode:"contain"}} source={{uri: 'data:image/jpeg;base64,' + this.state.base64userImage}} />
       </TouchableOpacity>
       <View style={{  marginTop:"1%"  }} >
         <Text  style={{ fontSize:20,color:"grey",marginLeft:5}}>Good </Text>
         <Text  style={{ fontSize:20,color:"grey",marginLeft:5}}>{this.state.timegreenting}</Text>
       </View>
     </View>
{/*
...
<View style={{  marginTop:"30%"}} >
     ...
     <Image style={{  width: 40, height: 40, borderRadius:27,marginTop:7,marginLeft:7 }} source={require('../imgs/NEWIMAGES/discover.png')} />
         ...
         <TouchableOpacity style={{position:"absolute",bottom:10,justifyContent: 'center',alignItems: 'center',textAlign:"center" , marginLeft:"5%",  backgroundColor:"pink",width: width*0.45,  borderRadius:12 ,  height: height*0.04  ,minHeight:36}}  onPress={() =>  this.props.navigation.navigate('goals')}>

          <Text  style={{  fontSize:20,color:"red",justifyContent: 'center',alignItems: 'center'  }}>View daily goals </Text>
        </TouchableOpacity>
      </TouchableOpacity>
     ...
     <View style={{  marginTop:"10%" }}>
       ...
       <View>
         <TouchableOpacity style={{width:width*0.3, height:  width*0.2,marginLeft:15,marginTop:15,justifyContent: 'center',alignItems: 'center'  }}  onPress={() =>  this.props.navigation.navigate('Excer')} >
             <Image style={{ height: '90%',    resizeMode:"contain" }} source={require('../imgs/NEWIMAGES/workout.png')} />
         </TouchableOpacity>
      ...
      <Image style={{ height: '100%',    resizeMode:"contain" }} source={require('../imgs/NEWIMAGES/ovulation.png')} />
       ...
       <View>
         <TouchableOpacity style={{width:width*0.3, height:  width*0.2,marginLeft:17,marginTop:15,justifyContent: 'center',alignItems: 'center'  }} onPress={() =>  this.props.navigation.navigate('bmi')} >
            <Image style={{ height: '90%',    resizeMode:"contain" }} source={require('../imgs/NEWIMAGES/track-bmi.png')} />
         </TouchableOpacity>
       ...
       <View>
         <TouchableOpacity style={{width:width*0.3, height:  width*0.2,marginLeft:12,marginTop:15,justifyContent: 'center',alignItems: 'center'  }} onPress={() =>  this.props.navigation.navigate('energy')} >
           <Image style={{ height: '90%',    resizeMode:"contain" }} source={require('../imgs/NEWIMAGES/energize.png')} />
         </TouchableOpacity>
