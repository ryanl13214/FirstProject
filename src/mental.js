...
const data_url = (a) => AsyncStorage.getItem(a);
 ...
 var setcurrentmood = function(a) {
  ...
  // AsyncStorage.setItem('mentalhealth'+month+year+day+isampm(),a);

SyncStorage.set('mentalhealth'+month+year+day+isampm(),a);
}
  ...
  return "200%";
    ...
    return (
      ...
      <View  style={{position:"absolute", height: "10%",  width: "80%",  flexDirection: 'row',justifyContent: "center",alignItems:"center",top:"24%",left:"10%"  }}>
          <TouchableOpacity   style={{   flexDirection: 'column',  width: "18%", height: "100%",marginLeft:"0%" }} onPress={() => setcurrentmood("amazing")} >

          </TouchableOpacity>
          <TouchableOpacity   style={{ flexDirection: 'column',  width: "18%", height: "100%",marginLeft:"2%" }} onPress={() => setcurrentmood("happy")} >

          </TouchableOpacity>
          <TouchableOpacity   style={{  flexDirection: 'column',   width: "18%", height: "100%",marginLeft:"2%" }} onPress={() => setcurrentmood("ok")} >

          </TouchableOpacity>
          <TouchableOpacity   style={{  flexDirection: 'column',   width: "18%", height: "100%",marginLeft:"2%" }} onPress={() => setcurrentmood("bad")} >

          </TouchableOpacity>
          <TouchableOpacity   style={{  flexDirection: 'column',  width: "18%", height: "100%",marginLeft:"2%" }} onPress={() => setcurrentmood("awful")} >
                    ...
                    <Image source={require('../imgs/water1.jpg')}    style={{ borderRadius:10 ,   width:20,  height: 20}}/>
                        ...
                        <TouchableOpacity    style={{top:settop(-1,"pm") ,position:"absolute",left:"68%",  flexDirection: 'column',borderRadius:18 ,  width: 36, height: 36 }}>
                          <Image source={require('../imgs/water1.jpg')}    style={{ borderRadius:10 ,   width:20,  height: 20}}/>
                              ...
                              <TouchableOpacity    style={{top:settop(0,"am") ,position:"absolute",left:"73%",  flexDirection: 'column',borderRadius:18 ,  width: 36, height: 36 }}>
                                <Image source={require('../imgs/water1.jpg')}    style={{ borderRadius:10 ,   width:20,  height: 20}}/>
                              </TouchableOpacity>
                              <TouchableOpacity    style={{top:settop(0,"pm")  ,position:"absolute",left:"78%",  flexDirection: 'column',borderRadius:18 ,  width: 36, height: 36 }}>
                                <Image source={require('../imgs/water1.jpg')}    style={{ borderRadius:10 ,   width:20,  height: 20}}/>
                              </TouchableOpacity>
