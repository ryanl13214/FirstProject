       ...
       <View style={{position:"absolute" ,bottom:"20%",left:" 10%",   width: '100%', height: '70%' }} >
         ...
         <View style={{width:"100%",justifyContent:"center",alignItems:"center"}}>
           <TouchableOpacity style={{ width:180, height:  120}}  onPress = {() =>  this.navigatetoovu("skin") } >
             <Image style={{  width:170, height: 120  ,  resizeMode: 'stretch' }} source={require('../imgs/Icons/skinicon.png')}  />
           </TouchableOpacity>
         </View>
       ...
       <View style={{position:"absolute" ,bottom:"20%",left:" 10%",   width: '100%', height: '70%' }} >
         ...
         <View style={{width:"100%",justifyContent:"center",alignItems:"center"}}>
           <TouchableOpacity style={{ width:180, height:  120}}  onPress = {() =>  this.navigatetoovu() } >
             <Image style={{  width:180, height: 120  ,  resizeMode: 'stretch' }} source={require('../imgs/Icons/skinicon.png')}  />
           </TouchableOpacity>
         </View>
   ...
   if (this.state.modalcontent =="High Cholesterol"){
     return (
       <View style={{position:"absolute" ,bottom:"20%",left:" 10%",   width: '100%', height: '70%' }} >
         ...
         <View style={{width:"100%",justifyContent:"center",alignItems:"center"}}>
           <TouchableOpacity style={{ width:180, height:  120}}  onPress = {() =>  this.navigatetoovu() } >
             <Image style={{  width:180, height: 120  ,  resizeMode: 'stretch' }} ssource={require('../imgs/Icons/skinicon.png')}  />
           </TouchableOpacity>
         </View>
