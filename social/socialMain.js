	...
	render() {
		...
		return (
			...
			<Image style={{position:"absolute",justifyContent: "center",alignItems:"center",  width: width, height: height,resizeMode: 'stretch',top:0 }} source={require('../imgs/revision3/socialMain1.jpg')} />
      			   ...
      			   <TouchableOpacity style={{position:"absolute"  ,top:height*0.685   ,left:0 ,     width:width*0.20, height:  height*0.2   }}  onPress={() =>  this.props.navigation.navigate('GroupFinder')} >
      			<Image style={{ width:width*0.40, height:  height*0.22,    resizeMode:"stretch",borderTopRightRadius:60}} source={require('../imgs/revision3/findgroups.jpg')} />
