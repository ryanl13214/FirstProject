    ...
    return (
      <View  style={{flex: 1,      alignItems: "flex-start",      justifyContent: "flex-start"}} >
        ...
        <View style={ styles.container}>
          <TouchableOpacity style={{ height:50, width:"100%" , flexDirection: 'column'  ,alignItems: 'center'  ,marginTop: "10%"}}  onPress={() =>  this.props.navigation.navigate('Home')} >
          <Text style={{ textAlign: 'center',fontSize: 25,width:"100%", height:50 ,color:"white"}}>Login </Text>
          </TouchableOpacity>
        </View>

        <TouchableOpacity style={{   position:"absolute" ,top:"0%",left:"8%",height:"5%", width:"45%" , flexDirection: 'column' ,marginTop: "10%"}}  onPress={() =>  this.props.navigation.navigate('Home')} >
          <Text style={{ textAlign: 'center',fontSize: 25,width:"100%", height:50 ,color:"white"}}>bypass login </Text>
        </TouchableOpacity>

        <TouchableOpacity style={{    position:"absolute" ,top:height*0.7,left:"28%",height:height*0.2, width:"45%" , flexDirection: 'column' ,marginTop: "10%"}}   onPress={() =>  this.props.navigation.navigate('register')} >
